...
<body>
  ...
  <div class="container">
    ...
    <form action="signup_check.php" method="post">
      <label>ユーザー名</label>
      <input type="text" name="name" placeholder="山田太郎" class="input-field" required>
    ...
    <div class="link" onclick="location.href='login.php'">ログインはこちら</div>
  </div>
